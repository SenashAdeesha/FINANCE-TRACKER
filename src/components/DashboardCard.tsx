...
function DashboardCard({ title, amount, icon, color }: Props) {
  return (
    <div className={`flex items-center justify-between p-5 rounded-xl shadow-sm ${color || "bg-white"} transition-transform transform hover:scale-105`}>
      <div>
