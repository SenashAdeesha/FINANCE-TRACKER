    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 text-white">
          ...
          <div className="text-3xl font-bold">{formatCurrency(recurringIncome)}</div>
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 text-white">
          ...
          <div className="text-3xl font-bold">{formatCurrency(oneTimeIncome)}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                {filteredIncome.map((income) => (
                  <div key={income.id} className="flex items-center justify-between p-5 bg-white/70 backdrop-blur-xl border border-white/80 rounded-2xl hover:bg-white/90 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 group">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">+{formatCurrency(Number(income.amount))}</div>
        ...
        <div className="bg-gradient-to-br from-white/90 via-green-50/40 to-emerald-50/40 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/60 p-8 relative overflow-hidden">
          ...
          <div className="mt-8 pt-8 border-t border-white/50">
            ...
            {(() => {
              // Group income by month with date sorting
              ...
              return sortedEntries.length > 0 ? (
                              ...
                              <div key={key} className="flex-1 flex justify-center relative group" style={{ height: '100%' }}>
                                <div className="absolute" style={{ bottom: `${yPosition}%`, transform: 'translateY(50%)' }}>
                                  ...
                                  <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity z-10 bg-gray-800 text-white px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap shadow-xl">
                                    ...
                                    <div className="text-green-300">{formatCurrency(data.amount)}</div>
                                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-gray-800"></div>
                                  </div>
                                  {/* Point */}
                                  <div className="relative">
                                    <div className="w-3 h-3 bg-green-500 border-2 border-white rounded-full shadow-lg cursor-pointer transform transition-all duration-200 group-hover:scale-150 group-hover:bg-green-600"></div>
                ...
                <div className="text-center py-8 text-gray-500 text-sm">
                  ...
                  <div className="text-xs">Add income entries to see the trend chart</div>
                </div>
              );
            })()}
          </div>
